...
function Main() {
  ...
  //This portion is the site menu link so same menu give the top menu ts file
  const siteMenu: Array<FormattedMenu | "divider"> = [
    {
        icon: "Users",
        title: "Users",
        pathname: '/users',
  ...
  const menu = () => {
    if (Cookies.get('viewsite')) // Check the view site click or not
      {
      return nestedMenu(siteMenu, location); //nestedMenu it's a function so i share the array value
    } else {
      return nestedMenu(menuStore, location);
    }
  };
